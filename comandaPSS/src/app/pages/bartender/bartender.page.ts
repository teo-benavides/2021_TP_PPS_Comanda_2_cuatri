...
export class BartenderPage implements OnInit {
  ...
  public prepararPreparacion(preparacion: Preparacion) {
    this.preparacionService.updatePreparacionState(preparacion.preparacionId, "preparando");
  }

  public terminarPreparacion(preparacion: Preparacion) {
    this.preparacionService.updatePreparacionState(preparacion.preparacionId, "terminado");
  }
